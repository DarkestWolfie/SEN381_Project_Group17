...
namespace SEN381_Project_Group17.PresentationLayer
{
    public partial class UkupholisaHub : Form
    {
        ...
        private void UkupholisaHub_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void UkupholisaHub_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void UkupholisaHub_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        private void UkupholisaHub_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }
