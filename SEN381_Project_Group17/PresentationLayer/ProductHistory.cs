...
namespace SEN381_Project_Group17.PresentationLayer
{
    public partial class ProductHistory : Form
    {
        ...
        //Constructor:
        public ProductHistory(string role)
        {
            InitializeComponent();
        ...
        private void ProductHistory_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void ProductHistory_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void ProductHistory_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void ProductHistory_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        ...
        {
            if (validation.prodHistoryVal(productID.Text, start.Text, end.Text))
            {
