...
namespace SEN381_Project_Group17.BusinessLayer
{
    internal class treatment_b
    {
        ...
        public treatment_b(int treatmentID, int treatmentConditionID, int treatmentProviderID, string treatmentName, string description, double cost)
        {
